...
describe('Grid', () => {
  ...
  describe('shouldUpdate', () => {
    it.only('should work through shouldUpdate', () => {
      ...
      const grid = render(tree, rootNode);

      // this is what the updates look like
      // (render is a mirror image)
      //
      //                      d
      //             d       d c
      //      d     d c     d c b
