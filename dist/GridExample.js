...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom.render(_react2['default'].createElement(_Layout2['default'], { onChange: function (breakpoint) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _examples = __webpack_require__(216);

	var _examples2 = _interopRequireDefault(_examples);

	var _modulesBanner = __webpack_require__(222);

	var _modulesBanner2 = _interopRequireDefault(_modulesBanner);

	var _modulesNav = __webpack_require__(223);

	var _modulesNav2 = _interopRequireDefault(_modulesNav);

	var DEFAULT = _Object$keys(_examples2['default'])[0];
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  getInitialState: function getInitialState() {
	    var initialExample = window.location.hash.replace('#', ''); // lame routing
	    return {
	      example: _examples2['default'].hasOwnProperty(initialExample) ? initialExample : DEFAULT
	    };
	  },

	  changeExample: function changeExample(newExample) {
	    this.setState({
	      example: newExample
	    });
	  ...
	  render: function render() {
	    var Example = _examples2['default'][this.state.example];
	    return _react2['default'].createElement(
	      _src.Grid,
	      { onChange: this.props.onChange },
	      _react2['default'].createElement(
	        _modulesBanner2['default'],
	        { className: 'header' },
	        'Cellblock'
	      ),
	      _react2['default'].createElement(_modulesNav2['default'], {
	        examples: _Object$keys(_examples2['default']),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _observeGrid = __webpack_require__(206);

	var _observeGrid2 = _interopRequireDefault(_observeGrid);

	exports['default'] = {
	  Grid: _Grid2['default'],
	  Row: _Row2['default'],
	  Column: _Column2['default'],
	  observeGrid: _observeGrid2['default']
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createClass = __webpack_require__(191)['default'];

	var _classCallCheck = __webpack_require__(194)['default'];
	...
	var _utilStyle = __webpack_require__(202);

	var _utilStyle2 = _interopRequireDefault(_utilStyle);

	var _eventlistener = __webpack_require__(203);

	var _eventlistener2 = _interopRequireDefault(_eventlistener);

	var _utilContext = __webpack_require__(197);

	var _utilContext2 = _interopRequireDefault(_utilContext);

	var _utilGetThreshold = __webpack_require__(204);

	var _utilGetThreshold2 = _interopRequireDefault(_utilGetThreshold);

	var _utilValidators = __webpack_require__(199);
	...
	var Grid = (function (_Component) {
	  ...
	  Grid.prototype.getMaxColWidth = function getMaxColWidth(units) {
	    var _props2 = this.props;
	    var breakPoints = _props2.breakPoints;
	    var columnWidth = _props2.columnWidth;
	    var gutterWidth = _props2.gutterWidth;
	    var flexible = _props2.flexible;

	    if (!flexible || Array.isArray(flexible) && flexible.indexOf(units) === -1) {
	      return columnWidth;
	    }

	    var nextPoint = breakPoints[breakPoints.indexOf(units) + 1];

	    if (!nextPoint) {
	      return Infinity;
	    } else {
	      var largeTotal = nextPoint * columnWidth + (nextPoint - 1) * gutterWidth;
	  ...
	  Grid.prototype.render = function render() {
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(_utilStyle2['default'], { gutter: this.props.gutterWidth }),
	      _react.Children.map(this.props.children, function (c) {
	        return _react.isValidElement(c) ? _react.cloneElement(c) : c;
	      })
	    );
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDesc  = __webpack_require__(182).getDesc
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilTypes = __webpack_require__(198);

	var _utilValidators = __webpack_require__(199);

	var _utilConstants = __webpack_require__(200);

	var _utilColMath = __webpack_require__(201);
	...
	var Column = (function (_Component) {
	  ...
	  Column.prototype.getChildContext = function getChildContext() {
	    var rawWidth = this.getPropForBreak('width') || this.context.colWidth;
	    var maxColWidth = this.props.isRoot ? this.props.maxColWidth : this.context.maxColWidth;

	    return {
	      maxColWidth: maxColWidth,
	      breakPoint: this.props.isRoot ? this.props.width : this.context.breakPoint,
	      colWidth: _utilColMath.computeSpan(rawWidth, this.context),
	      colMinPixelWidth: _utilColMath.computeMinWidth(rawWidth, this.context),
	      colMaxPixelWidth: _utilColMath.computeMaxWidth(rawWidth, this.context, maxColWidth)
	    };
	  };

	  Column.prototype.getPropForBreak = function getPropForBreak(prop) {
	    if (this.props.isRoot) return this.props[prop];
	    var breakProp = ['at' + this.context.breakPoint, prop].join('-');
	  ...
	  Column.prototype.render = function render() {
	    ...
	    var style = {};
	    var width = this.getPropForBreak('width');
	    var offset = this.getPropForBreak('offset');
	    var className = _classnames2['default'](_utilConstants.COL, this.props.className);

	    if (_utilTypes.isFraction(width)) {
	      style.width = _utilColMath.stringToPercent(width);
	    } else if (_utilTypes.isInteger(width)) {
	      style.width = _utilColMath.numberToPercent(width, this.context.colWidth);
	    }

	    if (_utilTypes.isFraction(offset)) {
	      style.marginLeft = _utilColMath.stringToPercent(offset);
	    } else if (_utilTypes.isInteger(offset)) {
	      style.marginLeft = _utilColMath.numberToPercent(offset, this.context.colWidth);
	    }
	  ...
	  _createClass(Column, null, [{
	    ...
	    value: {
	      ...
	      maxColWidth: _react.PropTypes.number,
	      offset: _utilValidators.gridUnit,
	      width: _utilValidators.gridUnit
	    },
	    enumerable: true
	  }, {
	    key: 'contextTypes',
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = {
	  maxColWidth: _react.PropTypes.number,
	  colUnitWidth: _react.PropTypes.number,
	  gutterWidth: _react.PropTypes.number,
	  colWidth: _react.PropTypes.number,
	  colMinPixelWidth: _react.PropTypes.number,
	  colMaxPixelWidth: _react.PropTypes.number,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.__esModule = true;
	exports.gridUnitFraction = gridUnitFraction;
	exports.gridUnitInteger = gridUnitInteger;
	...
	function gridUnitFraction(props, propName, componentName) {
	  var value = props[propName];
	  if (!_types.isFraction(value)) {
	    return createError(props, propName, componentName, 'expected a fraction string `a/b` (ie: 2/3)');
	  }
	}

	function gridUnitInteger(props, propName, componentName) {
	  var value = props[propName];
	  if (!_types.isInteger(value)) return createError(props, propName, componentName, 'expected an integer');
	}

	function gridUnit(props, propName, componentName) {
	  switch (true) {
	    case _types.isString(props[propName]):
	      return gridUnitFraction(props, propName, componentName);
	    case _types.isNumber(props[propName]):
	...
	function isAllIntegers(arr) {
	  for (var i = 0; i < arr.length; i += 1) {
	    if (!_types.isInteger(arr[i])) return false;
	  }
	  return true;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Style = (function (_Component) {
	  ...
	  Style.prototype.render = function render() {
	    ...
	    var style = '\n      .' + _constants.ROW + ':after, .' + _constants.COL + ':after{content:\'\';display:block;height:0;visibility:hidden;clear:both;}\n      .' + _constants.ROW + '{margin-left:auto;margin-right:auto;width:100%;}\n      .' + _constants.COL + '{box-sizing:border-box;-ms-box-sizing:border-box;-moz-box-sizing:border-box;width:100%;max-width:100%;float:left;min-height:1px;}\n      .' + _constants.COL + '{padding-left:' + gutter + 'px;padding-right:' + gutter + 'px;}\n      .' + _constants.COL + ' .' + _constants.ROW + '{margin-left:-' + gutter + 'px;margin-right:-' + gutter + 'px;width:auto;}\n    ';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Row = (function (_Component) {
	  ...
	  Row.prototype.render = function render() {
	    ...
	    var gutterWidth = _context.gutterWidth;
	    var colMaxPixelWidth = _context.colMaxPixelWidth;
	...
	function observeGrid(DumbComponent) {
	  return (function (_Component) {
	    ...
	    _createClass(_class, null, [{
	      key: 'displayName',
	      value: 'Grid' + (DumbComponent.displayName || DumbComponent.name),
	      enumerable: true
	    }, {
	      key: 'contextTypes',
	      value: _utilContext2['default'],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$assign = __webpack_require__(208)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S + $def.F, 'Object', {assign: __webpack_require__(211)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Copyfit = __webpack_require__(217);

	var _Copyfit2 = _interopRequireDefault(_Copyfit);

	var _Chess = __webpack_require__(219);

	var _Chess2 = _interopRequireDefault(_Chess);

	var _Wave = __webpack_require__(220);

	var _Wave2 = _interopRequireDefault(_Wave);

	var _Shuffle = __webpack_require__(221);

	var _Shuffle2 = _interopRequireDefault(_Shuffle);

	exports['default'] = {
	  'Copy Fit': _Copyfit2['default'],
	  'Chess': _Chess2['default'],
	  'Wave': _Wave2['default'],
	  'Shuffle & Nest': _Shuffle2['default']
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modulesTypeSize = __webpack_require__(218);

	var _modulesTypeSize2 = _interopRequireDefault(_modulesTypeSize);

	var LeftSection = _src.observeGrid(function (props) {
	  if (props.colWidth <= 4) {
	    return _react2['default'].createElement(
	      _src.Row,
	      { className: 'left-set' },
	      _react2['default'].createElement(
	        _src.Column,
	        null,
	        _react2['default'].createElement(_modulesTypeSize2['default'], null),
	        _react2['default'].createElement(_modulesTypeSize2['default'], null),
	        _react2['default'].createElement(_modulesTypeSize2['default'], null)
	      )
	    );
	    ...
	    _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          _src.Column,
	          { width: '1/2' },
	          _react2['default'].createElement(LeftSection, null)
	        ),
	        _react2['default'].createElement(
	          _src.Column,
	          { width: '1/2' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _src.observeGrid(function TypeSize(_ref) {
	  var className = _ref.className;
	  var colMaxPixelWidth = _ref.colMaxPixelWidth;
	  var colWidth = _ref.colWidth;

	  var padding = 15;
	  var headlineSize = (colMaxPixelWidth - 2 * padding) * (1 / 11);
	  var lineHeight = getLineHeight(headlineSize, colMaxPixelWidth, 1.2);
	  var baselineDiscrepancy = getbaselineDiscrepancy(headlineSize, lineHeight, 0.10);
	  ...
	  return _react2['default'].createElement(
	    'div',
	    { className: _classnames2['default']('module', className) },
	    _react2['default'].createElement(
	      'h2',
	      { style: style },
	...
	function getLineHeight(f, w) {
	  var bias = arguments.length <= 2 || arguments[2] === undefined ? 1 : arguments[2];

	  // f is font size
	  // w is column width
	  var ratio = phi - 1 / 2 * phi * (1 - w / Math.pow(f * phi, 2));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cell = _src.observeGrid(function (_ref) {
	  var dark = _ref.dark;
	  var colWidth = _ref.colWidth;
	  ...
	  return _react2['default'].createElement(
	    'div',
	    { className: 'chess-cell', style: style },
	    _react2['default'].createElement(
	      'span',
	      null,
	      colWidth >= 1 ? colWidth : ''
	  ...
	  for (var r = 0; r < 8; r += 1) {
	    ...
	    for (var c = 0; c < 8; c += 1) {
	      Columns.push(_react2['default'].createElement(
	        _src.Column,
	        { width: '1/8', key: c },
	        _react2['default'].createElement(Cell, { dark: !!((r + c) % 2) })
	      ));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _src.observeGrid(function Wave(_ref) {
	  var colWidth = _ref.colWidth;
	  var _ref$rows = _ref.rows;
	  var rows = _ref$rows === undefined ? 12 : _ref$rows;
	  ...
	  var _loop = function (r) {
	    var Columns = [];
	    var i = r % colWidth + 1;
	    var cols = i % 2 ? [colWidth - i, i] : [i, colWidth - i];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _src.observeGrid(function Shuffle(_ref) {
	  var colWidth = _ref.colWidth;

	  var fragment = [];
	  for (var i = 0; i < 19; i += 1) {
	    fragment.push(_react2['default'].createElement(RandomNest, { key: i }));
	  }
	  return _react2['default'].createElement(
	    'div',
	    null,
	...
	var Terminal = _src.observeGrid(function (_ref2) {
	  var children = _ref2.children;
	  var colWidth = _ref2.colWidth;

	  return _react2['default'].createElement('div', { className: colWidth < 1 ? 'terminal small' : 'terminal' });
	});

	var RandomNest = _src.observeGrid(function (_ref3) {
	  var colWidth = _ref3.colWidth;

	  var divisions = randomBool() ? 3 : 2;
	  if (colWidth / divisions < .6) return _react2['default'].createElement(Terminal, null);

	  var Split = divisions === 3 ? ThreeUp : TwoUp;
	  return _react2['default'].createElement(
	    Split,
	    null,
	    RandomFragment(divisions, Split)
	  );
	});
	...
	function RandomFragment(length, Component) {
	  ...
	  for (var i = 0; i < length; i += 1) {
	    fragment.push(randomBool() ? _react2['default'].createElement(RandomNest, { key: i }) : undefined);
	  }
	  return fragment;
	}
	...
	function getChild(children, idx) {
	  return children[idx] || _react2['default'].createElement(Terminal, null);
	}
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _src.observeGrid(function Banner(_ref) {
	  ...
	  return _react2['default'].createElement(
	    'div',
	    { className: _classnames2['default']('banner', className) },
	    _react2['default'].createElement(
	      'h2',
	      null,
	      children
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _src.observeGrid(function Nav(_ref) {
	  var colWidth = _ref.colWidth;
	  var examples = _ref.examples;
	  var changeExample = _ref.changeExample;
	  var activeExample = _ref.activeExample;
	  ...
	  return _react2['default'].createElement(
	    ...
	    rows.map(function (buttons, idx) {
	      return _react2['default'].createElement(
	        _src.Row,
	        { className: 'nav-buttons', key: idx },
	        buttons.map(function (name, idx) {
	          return _react2['default'].createElement(
	            _src.Column,
	            { key: idx, width: [1, buttons.length].join('/') },
	            _react2['default'].createElement(
	              'div',
	              {
	                className: _classnames2['default']('example-button', { active: name === activeExample }),
	...
	function split(arr, size) {
	  ...
	  for (i = 0; i < size; i++) {
	    for (j = 0; j < sizes[i]; j++) {
	      if (j === 0) out[i] = [arr[ptr]];else out[i].push(arr[ptr]);
	      ptr++;
	    }
	  }
